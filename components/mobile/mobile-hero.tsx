...
export default function MobileHero() {
  ...
  return (
    <section id="mobile-hero" className="relative h-[100svh] flex items-center justify-center overflow-hidden snap-start snap-always">
      ...
      {/* Content */}
      <div className="relative z-20 w-full max-w-6xl mx-auto text-center px-6 flex flex-col justify-center items-center h-full">
        <div
          className={`transition-all duration-1000 delay-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
          <h1 className="font-serif text-white text-[1.75rem] sm:text-3xl font-medium leading-[1.15] mb-5 text-balance drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]">
